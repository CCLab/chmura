...
#        'ENGINE': 'django.db.backends.sqlite3', # Add 'postgresql_psycopg2', 'postgresql', 'mysql', 'sqlite3' or 'oracle'.
        'NAME':   'budzet_w_slowach',
#        'NAME': '/home/alex/chmura/db.sql3',                      # Or path to database file if using sqlite3.
        'USER':   'chmura_slow',
...
SECRET_KEY = 'k&8-46xe-5^6mqwfk0k$7f)sxa$s$xmt-ng)njus3$tcu@sxc^'
